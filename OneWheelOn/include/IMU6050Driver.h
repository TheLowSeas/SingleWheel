/*Use #define MPU6050_ES before you include this file if you have an
engineering sample (older EVBs will have them), to find out if you have one,
check your accelerometer output. If it is half of what you expected, and you
still are on the correct planet, you got an engineering sample
*/

#ifndef IMU6050DRIVER_H
#define IMU6050DRIVER_H
...
#define MPU6050_ADDRESS 0x68 // address pin low (GND), default for InvenSense
// evaluation board
#endif
...
class MPU6050
{
  public:
    ...
    /**
       ...
       *
       * Macros: MPU6050_BW_256 - MPU6050_BW_188 - MPU6050_BW_98 -
       MPU6050_BW_42 - MPU6050_BW_20 - MPU6050_BW_10 - MPU6050_BW_5
       * Last number is the gyro's BW in Hz (accelero BW is virtually
       identical)
       *
    ...
    /**
       ...
       *
       * @param data - pointer to signed integer array with length three:
    ...
    /**
       * Writes data to the device, could be private, but public is handy so
       you can transmit directly to the MPU.
       *
    ...
    /**
       * Read data from the device, could be private, but public is handy so
       you can transmit directly to the MPU.
       *
       * @param adress - register address to write to
